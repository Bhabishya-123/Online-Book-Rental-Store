...
<body>
<nav class=" navbar-expand-lg navbar-light" style="background:rgb(60, 124, 197) ">
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" >
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link " href="index.php" id=""><b>POST</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="catagory.php" ><b>CATEGORY</b></a>
        </li>
        <li class="nav-item">
