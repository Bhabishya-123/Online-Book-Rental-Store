...
<tr>
    ...
    <td><a class="fn_link" href="update-post.php?id=<?php echo $row["book_id"] ?>"><i class='fa fa-edit'></i></a></td>
    <td><a class="fn_link" href="remove-post.php?id=<?php echo $row["book_id"] ?>"><i class='fa fa-trash'></i></a></td>
</tr>
